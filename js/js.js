...
const mainTime = {
    ...
    init(e) {
        ...
        mainTime.setMonthTable(mainTime.initDate.y, mainTime.Month)
    ...
    setMonthDate() {
        ...
        mainTime.setMonthTable(year, month)
    },
    ...
    setMonthTable(y, m) {
        ...
        function setWeekDayInfo(i, np) {
            ...
            el.nextElementSibling.dataset.day = mainTime.setDataDay(obDate);
        }
        if (!getToday()) {
